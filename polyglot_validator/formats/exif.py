...
class Exif(KaitaiStruct):
    ...
    class ExifBody(KaitaiStruct):
        ...
        class IfdField(KaitaiStruct):
            ...
            @property
            def type_len_data(self):
                if hasattr(self, '_m_type_len_data'):
                    return self._m_type_len_data

                self._m_type_len_data = (2 if self.field_type == Exif.ExifBody.IfdField.FieldTypeEnum.word else (4 if self.field_type == Exif.ExifBody.IfdField.FieldTypeEnum.dword else 1))
                return getattr(self, '_m_type_len_data', None)
            ...
            def len_data(self):
                ...
                self._m_len_data = (self.length * self.type_len_data)
            ...
            def is_immediate_data(self):
                ...
                self._m_is_immediate_data = self.len_data <= 4
